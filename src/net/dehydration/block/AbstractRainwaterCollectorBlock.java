...
public abstract class AbstractRainwaterCollectorBlock extends Block {
    private static final VoxelShape RAYCAST_SHAPE = createCuboidShape(2.0D, 2.0D, 2.0D, 14.0D, 16.0D, 14.0D);
    protected static final VoxelShape OUTLINE_SHAPE;
    private final Map<Item, RainwaterCollectorBehavior> behaviorMap;

    public AbstractRainwaterCollectorBlock(AbstractBlock.Settings settings, Map<Item, RainwaterCollectorBehavior> behaviorMap) {
        super(settings);
